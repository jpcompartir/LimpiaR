...
limpiar_slang <- function(df, text_var = mention_content){
  ...
  slang <- c("chaval", "me mola", "\\bmazo\\b", "\\bkeli\\b", "\\btuto\\b", "feten", "\\ba pachas",
             ...
             "(es|son|eres|sois) de lo(c|k)os", "\\bla ostia", "\\bla hostia", "cojonud(o|a)", "garito", "(da|das|dan) palo",
             ...
             "menudo marron", "esta de muerte", "miarma", "menuda leche", "me la suda", "me la pela", "pos ok|posok",
             ...
             "chido", "\\ba huevo\\b", "mirrey", "buena onda", "es\\w+ padre", "compa\\b", "\\bnaco\\b", "\\bnacos\\b",
  ...
  corrections <- c("nino", "me gusta", "mucho", "casa", "instituto", "estupendo", "por partes iguales",
                   ...
                   "que golpe", "no me importa", "no me importa", "ok", "chismoso", "estudioso",
