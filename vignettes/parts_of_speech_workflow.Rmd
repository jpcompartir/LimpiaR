...
Once we have the information regarding the co-occurrences of Nouns and Adjectives within documents, we are able to tell what entities appear throughout our data, as well as the type of language used in conjunction with and toward them. We can later do so by visualizing the frequency of terms appearing within the same document as well as those that are explicitly used one after another like the example above, where we see 'hot sun' appear most frequent.
